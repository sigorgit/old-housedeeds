...
import type {
  KIP37Holder,
  KIP37HolderInterface,
} from "../../../../klaytn-contracts/token/KIP37/KIP37Holder";
...
export class KIP37Holder__factory extends ContractFactory {
  ...
  override attach(address: string): KIP37Holder {
    return super.attach(address) as KIP37Holder;
  }
  override connect(signer: Signer): KIP37Holder__factory {
